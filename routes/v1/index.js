...
// const { getReports, getAllUsersReports, exportInternData, getTopandPoorPerformer } = require("../../controllers/reportController");
// const { getAllUsers, addUser, getAllBatchDates, updateUser, exportUsers, importUsers, getSingleUser } = require("../../controllers/usersController");
// const { getAllCourses, getACourse, fetchManyCourse, createOneCourse, fetchSingleCourse, updateOne, deleteCourse, exportCourses, deleteBulkCourses } = require("../../controllers/courses");
// const { fetchManyRoles, createOneRole, deleteJobRole } = require("../../controllers/jobRoles");
// const { getAllWeeklyStatues, getAllCoursesStatusCount, updateWeeklyStatusForUserOnCourse, handleEmailNotification } = require("../../controllers/weeklyStatusesController");
...
// const { getAllBatches, getABatch, addBatches, updateBatch, deleteBatches, exportBatch, getCoursesNameandId, importBatch } = require("../../controllers/batchController");
...
// router.route("/import/users").post(requireAuth, upload.array("files"), importUsers);
...
// router.route("/batch/importBatch").post(requireAuth, upload.array("files"), importBatch);
